...
const Results = ({ data }) => {
    ...
    return (
        <div className={`mt-8 lg:mt-16  lg:w-[80%] flex flex-col gap-2 text-center text-lg py-5 px-[40px] mx-auto  rounded-xl h-full ${showResults ? 'opacity-100 transform translate-y-0 transition-all duration-500 animate-fade-up animate-duration-[2000ms] bg-gray-900' : 'opacity-0 transform -translate-y-4 bg-gray-900'}`}>
